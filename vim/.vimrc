...
"" elsl   : [E]xecute [L]ine [S]plit [L]aunch   -- w/o count: "free", with count: "capture"
...
nnoremap <leader>elsr :<c-u>term ++close <c-r>=LineAsShellCmd(v:count, 1)<cr><cr>
nnoremap <leader>elsl :<c-u>term ++close <c-r>=LineAsShellCmd(v:count, 0)<cr><cr>
...
"" epsl   : [E]xecute [P]aragraph [S]plit [L]aunch   -- w/o count: "free", w/ count: "capture"
...
nnoremap <leader>epsr :<c-u>term ++close <c-r>=InnerParagraphAsShellCmd(v:count, 1)<cr><cr>
nnoremap <leader>epsl :<c-u>term ++close <c-r>=InnerParagraphAsShellCmd(v:count, 0)<cr><cr>
