...
""
"" For adjusting how gq works
""
nnoremap <leader>fo   <nop>
nnoremap <leader>fo?  :set fo?<cr>
nnoremap <leader>fo&  :set fo&<cr>
nnoremap <leader>fo2  :set fo+=2<cr>
nnoremap <leader>fon  <nop>
nnoremap <leader>fon2 :set fo+=2<cr>
...
function! InitMarkExecuteMaps() abort
    ...
    for ltr in "abcdefghijklmnopqrstuvwxyz"
        execute 'nmap <expr> <leader>emc' . l:ltr . ' ''\ab'' . (v:count==0?bufnr():v:count) . ''<cr>''''' . l:ltr . '\epc<c-o>\a,\ac'''
        execute 'nmap <expr> <leader>eml' . l:ltr . ' ''\ab'' . (v:count==0?bufnr():v:count) . ''<cr>''''' . l:ltr . '\epl<c-o>\a,\ac'''
        execute 'nmap <expr> <leader>emr' . l:ltr . ' ''\ab'' . (v:count==0?bufnr():v:count) . ''<cr>''''' . l:ltr . '\epr<c-o>\a,\ac'''
        execute 'nmap <expr> <leader>emd' . l:ltr . ' ''\ab'' . (v:count==0?bufnr():v:count) . ''<cr>''''' . l:ltr . ':Dispatch! <c-r><c-l><cr><c-o>\a,\ac'''
        execute 'nmap <expr> <leader>ema' . l:ltr . ' ''\ab'' . (v:count==0?bufnr():v:count) . ''<cr>''''' . l:ltr . '\eps<c-o>\a,\zz'''
    endfor
endfunction
